...
const reasons = {
    ...
    "4": `Your bot doesn't have any/enough working commands. (Minimum: 3)`,
  ...
  "7": `The owner is not in the server`
}
var modLog;
...
module.exports = class extends Command {
    ...
    async run(message, [Member]) {
        ...
        e = new MessageEmbed()
            ...
            .setColor(0xffaa00)
        message.channel.send(e)
     modLog.send('<:denied:758793490120573009> '+`<@${bot.botid}> by <@${bot.owners[0]}> has been removed/denied`+' For the reason:')
      modLog.send(r)
      message.author.send('**Hello** '+`${message.author}`+'\nThis is a confirmation message that you have removed the bot '+`<@${bot.botid}>`+'\n **THIS IS A AUTOMATED MESSAGE**')
